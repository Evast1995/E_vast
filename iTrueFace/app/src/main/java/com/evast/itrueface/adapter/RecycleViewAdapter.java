...
import com.evast.itrueface.activity.CourseDetailActivity;
...
public class RecycleViewAdapter extends RecyclerView.Adapter<MyHolder>{
    ...
    public void onBindViewHolder(MyHolder myHolder, int i) {
        ...
        myHolder.recycleLayout.setOnClickListener(new View.OnClickListener() {
            @Override
...
class MyHolder extends RecyclerView.ViewHolder{
    ...
    public LinearLayout recycleLayout;
    public MyHolder(View itemView) {
        ...
        recycleLayout = (LinearLayout) itemView.findViewById(R.id.recyle_layout);
    }
}
